...
#include <ns3/pf-ff-menb-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("PfFfMenbMacScheduler");

namespace ns3 {



int PfMenbType0AllocationRbg[4] = {
  10,       // RGB size 1
  26,       // RGB size 2
  63,       // RGB size 3
  110       // RGB size 4
...
NS_OBJECT_ENSURE_REGISTERED (PfFfMenbMacScheduler);



class PfMenbSchedulerMemberCschedSapProvider : public FfMacCschedSapProvider
{
public:
  PfMenbSchedulerMemberCschedSapProvider (PfFfMenbMacScheduler* scheduler);
...
private:
  PfMenbSchedulerMemberCschedSapProvider ();
  PfFfMenbMacScheduler* m_scheduler;
};

PfMenbSchedulerMemberCschedSapProvider::PfMenbSchedulerMemberCschedSapProvider ()
{
}

PfMenbSchedulerMemberCschedSapProvider::PfMenbSchedulerMemberCschedSapProvider (PfFfMenbMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
PfMenbSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
PfMenbSchedulerMemberCschedSapProvider::CschedUeConfigReq (const struct CschedUeConfigReqParameters& params)
{
...
void
PfMenbSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
PfMenbSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
PfMenbSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct CschedUeReleaseReqParameters& params)
{
...
void
PfMenbSchedulerMemberCschedSapProvider::CschedCellUpdateConfigReq(const struct CschedCellUpdateConfigReqParameters& params)
{
...
class PfMenbSchedulerMemberSchedSapProvider : public FfMacSchedSapProvider
{
public:
  PfMenbSchedulerMemberSchedSapProvider (PfFfMenbMacScheduler* scheduler);
...
private:
  PfMenbSchedulerMemberSchedSapProvider ();
  PfFfMenbMacScheduler* m_scheduler;
};



PfMenbSchedulerMemberSchedSapProvider::PfMenbSchedulerMemberSchedSapProvider ()
{
}


PfMenbSchedulerMemberSchedSapProvider::PfMenbSchedulerMemberSchedSapProvider (PfFfMenbMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct SchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct SchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct SchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct SchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct SchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct SchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
PfMenbSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct SchedUlCqiInfoReqParameters& params)
{
...
PfFfMenbMacScheduler::PfFfMenbMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_timeWindow (99.0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new PfMenbSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new PfMenbSchedulerMemberSchedSapProvider (this);
}
...
void
PfFfMenbMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
PfFfMenbMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PfFfMenbMacScheduler")
    .SetParent<FfMacScheduler> ()
    .AddConstructor<PfFfMenbMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&PfFfMenbMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&PfFfMenbMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&PfFfMenbMacScheduler::m_ulGrantMcs),
...
void
PfFfMenbMacScheduler::SetFfMacCschedSapUser (FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
PfFfMenbMacScheduler::SetFfMacSchedSapUser (FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

FfMacCschedSapProvider*
PfFfMenbMacScheduler::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

FfMacSchedSapProvider*
PfFfMenbMacScheduler::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
PfFfMenbMacScheduler::DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMenbMacScheduler::DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
PfFfMenbMacScheduler::DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
...
void
PfFfMenbMacScheduler::DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMenbMacScheduler::DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMenbMacScheduler::DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
PfFfMenbMacScheduler::DoSchedDlPagingBufferReq (const struct FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMenbMacScheduler::DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
PfFfMenbMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
      if (dlbandwidth < PfMenbType0AllocationRbg[i])
        {
          return (i + 1);
        }
    }
...
int
PfFfMenbMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
...
uint8_t
PfFfMenbMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
PfFfMenbMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
PfFfMenbMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMenbMacScheduler::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
  ...
  //Compute the High interference indicators
  LteICIC l;
  l.MenbHii(m_flowStatsDl, m_a30CqiRxed, rbgSize, rbgNum);
  m_highInterferenceInformationList = l.getHii();
  if(l.isHII==true)
  {
     DoConfigureHii();
  }
  for (int i = 0; i < rbgNum; i++)
    {
      ...
      if (rbgMap.at (i) == false)		//if the resource block is free?
      {
          ...
          double rcqiMax = 0.0;
           ...
           /*for(int p=0;p<12;p++)
                  {
                	  if(m_highInterferenceInformationList[p])
                	  {
                		  std::cout << "Hii " << p << std::endl;
                	  }

              }
              */
          //m_cschedSapUser->UlHighInterferenceInformationList = Hii;		//sends HII to the csched sap
          //DO WE CALL doCschedCellConfigUpdateInd here
...
void
PfFfMenbMacScheduler::DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMenbMacScheduler::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
PfFfMenbMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
PfFfMenbMacScheduler::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
PfFfMenbMacScheduler::DoSchedUlNoiseInterferenceReq (const struct FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PfFfMenbMacScheduler::DoSchedUlSrInfoReq (const struct FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PfFfMenbMacScheduler::DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMenbMacScheduler::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
// retrieve the allocation for this subframe
  ...
  switch (params.m_ulCqi.m_type)
    ...
    case UlCqi_s::PRACH:
      {
        NS_FATAL_ERROR ("PfFfMenbMacScheduler supports only PUSCH and SRS UL-CQIs");
      }
      break;
    default:
...
void
PfFfMenbMacScheduler::RefreshDlCqiMaps (void)
{
...
void
PfFfMenbMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
PfFfMenbMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
void
PfFfMenbMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
PfFfMenbMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
...
void
PfFfMenbMacScheduler::DoConfigureHii()
{
	  NS_LOG_FUNCTION (this);
	  FfMacCschedSapUser::CschedCellConfigUpdateIndParameters params;
	  params.UlHighInterferenceInformationList = m_highInterferenceInformationList;
	  m_cschedSapUser->CschedCellConfigUpdateInd(params);
