...
public:
  ...
  virtual void CellUpdateConfigurationReq(cellConfig params);
...
void
EnbMacMemberLteEnbCmacSapProvider::CellUpdateConfigurationReq(cellConfig params)
{
	m_mac->DoCellUpdateConfigurationReq(params);
}
...
LteEnbMac::DoDispose ()
{
  ...
  m_highInterferenceInformationList.clear();
...
//Propogating from the RRC to the scheduler
void
...
void
LteEnbMac::DoCellUpdateConfigurationReq(LteEnbCmacSapProvider::cellConfig params){

	m_highInterferenceInformationList = params.HighInterferenceInformationList;

	//Propagate from the RRC to the scheduler
	FfMacCschedSapProvider::CschedCellUpdateConfigReqParameters req;
	req.HighInterferenceInformationList = params.HighInterferenceInformationList;
	m_cschedSapProvider->CschedCellUpdateConfigReq(req);
...
{
  NS_LOG_FUNCTION (this);
  m_highInterferenceInformationList = params.UlHighInterferenceInformationList;
  LteEnbCmacSapUser::cellConfig cellConfigUpdate;
  cellConfigUpdate.HighInterferenceInformationList = m_highInterferenceInformationList;
  //Propagate this to the RRC
  m_cmacSapUser->RrcCellConfigurationUpdateInd(cellConfigUpdate);
