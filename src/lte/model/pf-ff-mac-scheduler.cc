...
void
PfSchedulerMemberCschedSapProvider::CschedCellUpdateConfigReq(const struct CschedCellUpdateConfigReqParameters& params)
{
...
/*
          ...
          LteICIC l;
          l.MenbHii(m_flowStatsDl, m_a30CqiRxed, rbgMap, rbgSize, rbgNum);
          std::vector<bool> hii = l.getHii();
