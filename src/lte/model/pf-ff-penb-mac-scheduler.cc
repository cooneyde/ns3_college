...
#include <ns3/pf-ff-penb-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("PfFfpenbMacScheduler");

namespace ns3 {



int PfPenbType0AllocationRbg[4] = {
  10,       // RGB size 1
  26,       // RGB size 2
  63,       // RGB size 3
  110       // RGB size 4
...
NS_OBJECT_ENSURE_REGISTERED (PfFfPenbMacScheduler);



class PfPenbSchedulerMemberCschedSapProvider : public FfMacCschedSapProvider
{
public:
  PfPenbSchedulerMemberCschedSapProvider (PfFfPenbMacScheduler* scheduler);
  ...
  virtual void CschedCellUpdateConfigReq(const struct CschedCellUpdateConfigReqParameters& params);

private:
  PfPenbSchedulerMemberCschedSapProvider ();
  PfFfPenbMacScheduler* m_scheduler;
};

PfPenbSchedulerMemberCschedSapProvider::PfPenbSchedulerMemberCschedSapProvider ()
{
}

PfPenbSchedulerMemberCschedSapProvider::PfPenbSchedulerMemberCschedSapProvider (PfFfPenbMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
PfPenbSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct CschedCellConfigReqParameters& params)
{
...
void
PfPenbSchedulerMemberCschedSapProvider::CschedUeConfigReq (const struct CschedUeConfigReqParameters& params)
{
...
void
PfPenbSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
PfPenbSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
PfPenbSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct CschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

void
PfPenbSchedulerMemberCschedSapProvider::CschedCellUpdateConfigReq(const struct CschedCellUpdateConfigReqParameters& params)
{
	//std::cout << "HII" << std::endl;
	m_scheduler-> DoCschedCellUpdateConfigReq(params);
}


class PfPenbSchedulerMemberSchedSapProvider : public FfMacSchedSapProvider
{
public:
  PfPenbSchedulerMemberSchedSapProvider (PfFfPenbMacScheduler* scheduler);
...
private:
  PfPenbSchedulerMemberSchedSapProvider ();
  PfFfPenbMacScheduler* m_scheduler;
};



PfPenbSchedulerMemberSchedSapProvider::PfPenbSchedulerMemberSchedSapProvider ()
{
}


PfPenbSchedulerMemberSchedSapProvider::PfPenbSchedulerMemberSchedSapProvider (PfFfPenbMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct SchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct SchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct SchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct SchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct SchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct SchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
PfPenbSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct SchedUlCqiInfoReqParameters& params)
{
...
PfFfPenbMacScheduler::PfFfPenbMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_timeWindow (99.0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new PfPenbSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new PfPenbSchedulerMemberSchedSapProvider (this);
}
...
void
PfFfPenbMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
PfFfPenbMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PfFfPenbMacScheduler")
    .SetParent<FfMacScheduler> ()
    .AddConstructor<PfFfPenbMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&PfFfPenbMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&PfFfPenbMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&PfFfPenbMacScheduler::m_ulGrantMcs),
...
void
PfFfPenbMacScheduler::SetFfMacCschedSapUser (FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
PfFfPenbMacScheduler::SetFfMacSchedSapUser (FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

FfMacCschedSapProvider*
PfFfPenbMacScheduler::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

FfMacSchedSapProvider*
PfFfPenbMacScheduler::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
PfFfPenbMacScheduler::DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfPenbMacScheduler::DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
PfFfPenbMacScheduler::DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
...
void
PfFfPenbMacScheduler::DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfPenbMacScheduler::DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfPenbMacScheduler::DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
PfFfPenbMacScheduler::DoSchedDlPagingBufferReq (const struct FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfPenbMacScheduler::DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
void
PfFfPenbMacScheduler::DoCschedCellUpdateConfigReq(const struct FfMacCschedSapProvider::CschedCellUpdateConfigReqParameters& params)
{
	m_highInterferenceInformationList = params.HighInterferenceInformationList;
}



int
PfFfPenbMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
      if (dlbandwidth < PfPenbType0AllocationRbg[i])
        {
          return (i + 1);
        }
    }
...
int
PfFfPenbMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
...
uint8_t
PfFfPenbMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
PfFfPenbMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
PfFfPenbMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
PfFfPenbMacScheduler::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
  NS_LOG_FUNCTION (this << " Frame no. " << (params.m_sfnSf >> 4) << " subframe no. " << (0xF & params.m_sfnSf));
  // API generated by RLC for triggering the scheduling of a DL subframe
  NS_LOG_INFO("PeNB Scheduling");
 // std::cout << "PeNB scheduling" << std::endl;

  // evaluate the relative channel quality indicator for each UE per each RBG
  // (since we are using allocation type 0 the small unit of allocation is RBG)
  // Resource allocation type 0 (see sec 7.1.6.1 of 36.213)

  RefreshDlCqiMaps ();	//Update the A30 and P10 CQI maps
  ...
  LteICIC l;
  l.setHii(m_highInterferenceInformationList);
  l.PenbHii(rbgMap,rbgSize,rbgNum);

  for (int i = 0; i < rbgNum; i++)
    {
      NS_LOG_INFO (this << " ALLOCATION for RBG " << i << " of " << rbgNum);

      if (rbgMap.at (i) == false)		//if the resource block is free?
      {
    	  std::map <uint16_t, pfsFlowPerf_t>::iterator it;
          std::map <uint16_t, pfsFlowPerf_t>::iterator itMax = m_flowStatsDl.end ();
          double rcqiMax = 0.0;

          /*Takes the HII data sent to the enb which is propagated through the RRC and MAC layers
           * and then recomputes the rbgmap for the scheduler
           */
          ...
          for (it = m_flowStatsDl.begin (); it != m_flowStatsDl.end (); it++)
            {
              ...
              if ((itRnti != rntiAllocated.end ())||(!HarqProcessAvailability ((*it).first)))
                {
                  ...
                  if (itRnti != rntiAllocated.end ())
                  {
                   ...
                   // std::cout << "RNTI DISCARDED FOR HARQ TX" << std::endl;
                  }
              ...
              itCqi = m_a30CqiRxed.find ((*it).first);	//gets CQI for a UE
             /*
              std::cout << "UE : " << (*itCqi).first << "Bandwidth part: " << (int)(*itCqi).second.m_bwPart.m_bwPartIndex
            		    << "Preferred subband: " << (int)(*itCqi).second.m_bwPart.m_sb << " CQI: "
            		    << (int)(*itCqi).second.m_bwPart.m_cqi << std::endl;
             */

              //std::cout  << (int)(*itCqi).second.m_bwPart.m_cqi << std::endl;
...
void
PfFfPenbMacScheduler::DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfPenbMacScheduler::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
PfFfPenbMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
PfFfPenbMacScheduler::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
PfFfPenbMacScheduler::DoSchedUlNoiseInterferenceReq (const struct FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PfFfPenbMacScheduler::DoSchedUlSrInfoReq (const struct FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PfFfPenbMacScheduler::DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfPenbMacScheduler::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
// retrieve the allocation for this subframe
  ...
  switch (params.m_ulCqi.m_type)
    ...
    case UlCqi_s::PRACH:
      {
        NS_FATAL_ERROR ("PfFfPenbMacScheduler supports only PUSCH and SRS UL-CQIs");
      }
      break;
    default:
...
void
PfFfPenbMacScheduler::RefreshDlCqiMaps (void)
{
  ...
  while (itP10 != m_p10CqiTimers.end ())
    {
     ...
     // if ((*itP10).second < 980)
    //	  std::cout << " P10-CQI for user " << (*itP10).first << " is " << (uint32_t)(*itP10).second << " thr " << (uint32_t)m_cqiTimersThreshold << std::endl;
      if ((*itP10).second == 0)
        {
  ...
  while (itA30 != m_a30CqiTimers.end ())
    ...
    //  std::cout << " A30-CQI for user " << (*itA30).first << " is " << (uint32_t)(*itA30).second << " thr " << (uint32_t)m_cqiTimersThreshold<<std::endl;
      if ((*itA30).second == 0)
        {
          // delete correspondent entries
...
void
PfFfPenbMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
PfFfPenbMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
void
PfFfPenbMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
PfFfPenbMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
