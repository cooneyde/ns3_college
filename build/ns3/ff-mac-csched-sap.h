...
public:
  ...
  struct CschedCellUpdateConfigReqParameters
  {
  ...
  virtual void CschedCellUpdateConfigReq(const struct CschedCellUpdateConfigReqParameters& params) = 0;
...
public:
  ...
  /*
   * Boolean vector indicating resource blocks with high interference.
   * Data to be relayed onto the RRC layer
   */
  std::vector<bool> UlHighInterferenceInformationList;
  /**
   * Parameters of the API primitives
   */
