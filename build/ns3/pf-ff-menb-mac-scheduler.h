...
#ifndef PF_FF_MENB_MAC_SCHEDULER_H
#define PF_FF_MENB_MAC_SCHEDULER_H
...
class PfFfMenbMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
  ...
  friend class PfMenbSchedulerMemberCschedSapProvider;
  friend class PfMenbSchedulerMemberCschedSapUser;
  friend class PfMenbSchedulerMemberSchedSapProvider;
...
private:
 ...
 // void DoCschedCellConfigUpdateInd(struct FfMacCschedSapUser::CschedCellConfigUpdateIndParameters& params);
...
#endif /* PF_FF_MENB_MAC_SCHEDULER_H */
