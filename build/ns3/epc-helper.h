...
public:
  ...
  /** 
    * Add an eNB to the EPC
    *
    * \param PenbNode the previosuly created eNB node which is to be
    * added to the EPC
    * \param lteEnbNetDevice the LteEnbNetDevice of the PeNB node
    * \param cellId ID of the PeNB
    */
   void AddPEnb(Ptr<Node> Penb, Ptr <Node> Menb, Ptr<NetDevice> ltePenbNetDevice, uint16_t cellId);
