...
private:
  ...
  */
  ...
  void DoCellUpdateConfigurationReq(LteEnbCmacSapProvider::cellConfig params);
...
private:
  ...
  std::vector<bool> m_highInterferenceInformationList;	  // UL High interference indicators on resource blocks
