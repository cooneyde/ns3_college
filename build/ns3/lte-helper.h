...
public:
  ...
  NetDeviceContainer InstallPEnbDevice (NodeContainer c, NodeContainer m, bool schedstat);
...
private:
  ...
  Ptr<NetDevice> InstallSinglePEnbDevice (Ptr<Node> n, Ptr<Node> MeNB, bool stat);
