...
#ifndef PF_FF_PENB_MAC_SCHEDULER_H
#define PF_FF_PENB_MAC_SCHEDULER_H
...
class PfFfPenbMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
  ...
  friend class PfPenbSchedulerMemberCschedSapProvider;
  friend class PfPenbSchedulerMemberCschedSapUser;
  friend class PfPenbSchedulerMemberSchedSapProvider;
  //friend class LteICIC;
...
private:
  ...
  void DoCschedCellUpdateConfigReq(const struct FfMacCschedSapProvider::CschedCellUpdateConfigReqParameters& params);
  ...
  */
  ...
  //High interference indicator boolean vector
  std::vector<bool> m_highInterferenceInformationList;
...
#endif /* PF_FF_PENB_MAC_SCHEDULER_H */
